...
class WidgetSelectionModal extends StatefulWidget {
  ...
  @override
  State<WidgetSelectionModal> createState() => _WidgetSelectionModalState();
}

class _WidgetSelectionModalState extends State<WidgetSelectionModal> {
