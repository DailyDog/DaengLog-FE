...
class GptLoadingBoxWidget extends StatelessWidget {
  const GptLoadingBoxWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final defaultProfile = Provider.of<DefaultProfile>(context, listen: false);
