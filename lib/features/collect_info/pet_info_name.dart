...
class PetInformationName extends StatefulWidget {
  final void Function(String name, DateTime? birthday, String gender) onNext;
  
  const PetInformationName({Key? key, required this.onNext}) : super(key: key);

  @override
  State<PetInformationName> createState() => _PetInformationNameState();
}

class _PetInformationNameState extends State<PetInformationName> {
