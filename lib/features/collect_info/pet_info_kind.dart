...
class PetInformationKind extends StatefulWidget {
  final void Function(String kind) onNext;
  
  const PetInformationKind({Key? key, required this.onNext}) : super(key: key);

  @override
  State<PetInformationKind> createState() => _PetInformationKindState();
}

class _PetInformationKindState extends State<PetInformationKind> {
  String? selectedKind;
