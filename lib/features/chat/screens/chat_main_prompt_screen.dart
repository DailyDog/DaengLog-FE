...
class ChatMainPromptScreen extends StatefulWidget {
  const ChatMainPromptScreen({Key? key}) : super(key: key);

  @override
  State<ChatMainPromptScreen> createState() => _ChatMainPromptScreenState();
}

class _ChatMainPromptScreenState extends State<ChatMainPromptScreen> {
